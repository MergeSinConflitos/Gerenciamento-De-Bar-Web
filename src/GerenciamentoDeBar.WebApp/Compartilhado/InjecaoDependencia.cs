...
using GerenciamentoDeBar.WebApp.Compartilhado.Identity;
using GerenciamentoDeBar.WebApp.Compartilhado.Mapping;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Identity;

namespace GerenciamentoDeBar.WebApp.Compartilhado;
...
public static class InjecaoDependencia
{
    ...
    IConfiguration configuration)
    {
        services.AddControllersWithViews().AddRazorOptions(options =>
        {
            ...
            // Localização das Views dos módulos: Modulos/ModuloMesa/Views/Listar.cshtml
